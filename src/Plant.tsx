...
export const THRESHOLDS = [0.1, 0.23, 0.36, 0.49, 0.62, 0.75];

export const LEAF_PATH = "M0 0 C 9 -1, 17 -9, 15.5 -21 C 7 -19, 1.5 -11, 0 0 Z";
export const TOP_PATH = "M0 0 C -5 -8, -4 -18, 0 -24 C 4 -18, 5 -8, 0 0 Z";
...
export function Plant({ progress, phase }: { progress: number; phase: PlantPhase }) {
  ...
  return (
    <svg
      className={`plant ${phase === "wilt" ? "wilted" : phase}`}
      viewBox="0 0 64 264"
      aria-hidden="true"
    >
      {/* pot */}
